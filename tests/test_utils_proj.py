...
@pytest.mark.project_setup(manifest=dict(odoo_version="16.0", project_id="4321"))
def test_get_project_manifest_2(project):
    manifest = proj_utils.get_project_manifest()
    expected = {
        "country": "ch",
        "customer_name": "ACME Inc.",
...
def test_get_project_manifest_key(project):
...
def test_generate_odoo_config_file(project):
